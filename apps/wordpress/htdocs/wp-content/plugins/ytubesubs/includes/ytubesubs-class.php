<?php
/**
 * Adds Ytube_subs widget.
 */
class Ytube_subs_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'ytubesubs_widget', // Base ID
			esc_html__( 'Ytube Subs', 'yts_domain' ), // Name
			array( 'description' => esc_html__( 'Widget for displaying youtube subs', 'yts_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget'];//Things to display before widget(<div>, etc.)
		...
		echo $args['after_widget'];//Things to display after widget(</div>, etc.)
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Ytube Subs', 'yts_domain' );
		$channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'frostwolfusv', 'yts_domain' );

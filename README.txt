                    Bitnami WordPress Stack 5.2.2-0
                  ==============================
...
bitnami-wordpress-5.2.2-0-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-5.2.2-0-windows-installer.exe on Windows or
bitnami-wordpress-5.2.2-0-osx-x64-installer.dmg on OS X.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-wordpress-5.2.2-0-linux-x64-installer.run
...
in /home/user/wordpress-5.2.2-0 on Linux or
C:\Bitnami\wordpress-5.2.2-0 on Windows or
/Applications/wordpress-5.2.2-0 on OS X and that you use port 8080
...
/home/user/wordpress-5.2.2-0/apache2/logs/error.log on Linux or
C:\bitnami\wordpress-5.2.2-0\apache2\logs\error.log on Windows or
/Applications/wordpress-5.2.2-0/apache2/logs/error.log.
